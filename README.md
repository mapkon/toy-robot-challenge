...
A commandline simulation of a Robot on a 5x5 grid.
...
On the comandline, run the command: 
	`mvn test`

## To Run

On a commandline, run the command: 
	`mvn exec:java`
...
See implementation-notes.md for the implementation notes