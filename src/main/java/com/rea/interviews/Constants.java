...
public class Constants {
	...
	public static final String INVALID_X_COORDINATE = "X coordinate cannot be above 4.";
	public static final String INVALID_Y_COORDINATE = "Y coordinate cannot be above 4.";
